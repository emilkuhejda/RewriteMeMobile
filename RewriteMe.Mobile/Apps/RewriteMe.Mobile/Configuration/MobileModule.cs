...
namespace RewriteMe.Mobile.Configuration
{
    public class MobileModule : IUnityModule
    {
        ...
        private static void RegisterPages(IContainerRegistry containerRegistry)
        {
            ...
            containerRegistry.RegisterForNavigation<IntroTwoPage, IntroTwoPageViewModel>(Pages.IntroTwo);
            ...
            containerRegistry.RegisterForNavigation<TranscriptionDetailPage, TranscriptionDetailPageViewModel>(Pages.TranscriptionDetail);
