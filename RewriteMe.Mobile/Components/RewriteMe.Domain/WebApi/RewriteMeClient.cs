...
namespace RewriteMe.Domain.WebApi
{
    ...
    public partial class RewriteMeClient
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<FileItem> UploadFileItemAsync(string name, string language, string fileName, System.DateTime? dateCreated, System.Guid? applicationId, string version, System.IO.Stream body)
        {
            return UploadFileItemAsync(name, language, fileName, dateCreated, applicationId, version, body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<FileItem> UploadFileItemAsync(string name, string language, string fileName, System.DateTime? dateCreated, System.Guid? applicationId, string version, System.IO.Stream body, System.Threading.CancellationToken cancellationToken)
        {
            if (version == null)
                throw new System.ArgumentNullException("version");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v{version}/files/upload?");
            urlBuilder_.Replace("{version}", System.Uri.EscapeDataString(ConvertToString(version, System.Globalization.CultureInfo.InvariantCulture)));
            if (name != null)
            {
                urlBuilder_.Append(System.Uri.EscapeDataString("name") + "=").Append(System.Uri.EscapeDataString(ConvertToString(name, System.Globalization.CultureInfo.InvariantCulture))).Append("&");
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<FileItem> UploadSourceFileAsync(System.Guid fileItemId, System.Guid? applicationId, string version, System.IO.Stream body)
        {
            return UploadSourceFileAsync(fileItemId, applicationId, version, body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<FileItem> UploadSourceFileAsync(System.Guid fileItemId, System.Guid? applicationId, string version, System.IO.Stream body, System.Threading.CancellationToken cancellationToken)
        {
            if (fileItemId == null)
                throw new System.ArgumentNullException("fileItemId");
            ...
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v{version}/files/{fileItemId}/upload?");
            urlBuilder_.Replace("{fileItemId}", System.Uri.EscapeDataString(ConvertToString(fileItemId, System.Globalization.CultureInfo.InvariantCulture)));
            urlBuilder_.Replace("{version}", System.Uri.EscapeDataString(ConvertToString(version, System.Globalization.CultureInfo.InvariantCulture)));
            if (applicationId != null)
            {
        ...
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<FileItem> UpdateFileItemAsync(string version, System.IO.Stream body)
        {
            return UpdateFileItemAsync(version, body, System.Threading.CancellationToken.None);
        }

        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        /// <returns>Success</returns>
        /// <exception cref="ApiException">A server side error occurred.</exception>
        public async System.Threading.Tasks.Task<FileItem> UpdateFileItemAsync(string version, System.IO.Stream body, System.Threading.CancellationToken cancellationToken)
        {
            if (version == null)
                throw new System.ArgumentNullException("version");

            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/v{version}/files/update");
            urlBuilder_.Replace("{version}", System.Uri.EscapeDataString(ConvertToString(version, System.Globalization.CultureInfo.InvariantCulture)));
    ...
    public partial class FileItem
    {
        ...
        [Newtonsoft.Json.JsonProperty("recognitionStateString", Required = Newtonsoft.Json.Required.AllowNull)]
    ...
    public partial class LanguageVersion
    {
        ...
        [Newtonsoft.Json.JsonProperty("languageString", Required = Newtonsoft.Json.Required.AllowNull)]
    ...
    public partial class InformationMessage
    {
        ...
        [Newtonsoft.Json.JsonProperty("dateUpdatedUtc", Required = Newtonsoft.Json.Required.AllowNull)]
        public System.DateTime? DateUpdatedUtc { get; set; }
    ...
    public partial class SpeechResultModel
    {
        ...
        [Newtonsoft.Json.JsonProperty("totalTime", Required = Newtonsoft.Json.Required.Always)]
    ...
    public partial class TranscribeItem
    {
        ...
        [Newtonsoft.Json.JsonProperty("alternatives", Required = Newtonsoft.Json.Required.AllowNull)]
        public System.Collections.Generic.IEnumerable<RecognitionAlternative> Alternatives { get; set; }

        [Newtonsoft.Json.JsonProperty("userTranscript", Required = Newtonsoft.Json.Required.AllowNull)]
    ...
    public partial class UpdateUserModel
    {
        ...
        [Newtonsoft.Json.JsonProperty("familyName", Required = Newtonsoft.Json.Required.AllowNull)]
    ...
    public partial class RegistrationDeviceModel
    {
        ...
        [Newtonsoft.Json.JsonProperty("runtimePlatform", Required = Newtonsoft.Json.Required.AllowNull)]
        public string RuntimePlatform { get; set; }

        [Newtonsoft.Json.JsonProperty("installedVersionNumber", Required = Newtonsoft.Json.Required.AllowNull)]
    ...
    {
        [Newtonsoft.Json.JsonProperty("subscriptionKey", Required = Newtonsoft.Json.Required.AllowNull)]
        public string SubscriptionKey { get; set; }

        [Newtonsoft.Json.JsonProperty("speechRegion", Required = Newtonsoft.Json.Required.AllowNull)]
