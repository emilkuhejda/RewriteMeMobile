...
namespace RewriteMe.Domain.WebApi.Models
{
    ...
    public partial class StringSegment
    {
        ...
        /// Initializes a new instance of the StringSegment class.
        /// </summary>
        public StringSegment(string buffer = default(string), int? offset = default(int?), int? length = default(int?), string value = default(string), bool? hasValue = default(bool?))
        {
            Buffer = buffer;
            Offset = offset;
            Length = length;
