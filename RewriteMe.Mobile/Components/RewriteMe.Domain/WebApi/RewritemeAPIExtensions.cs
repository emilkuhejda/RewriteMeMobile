...
namespace RewriteMe.Domain.WebApi
{
    ...
    public static partial class RewriteMeAPIExtensions
    {
            ...
            /// </param>
            public static object MarkMessageAsOpened(this IRewriteMeAPI operations, System.Guid? informationMessageId = default(System.Guid?))
            {
                return operations.MarkMessageAsOpenedAsync(informationMessageId).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> MarkMessageAsOpenedAsync(this IRewriteMeAPI operations, System.Guid? informationMessageId = default(System.Guid?), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.MarkMessageAsOpenedWithHttpMessagesAsync(informationMessageId, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
            ...
            /// <param name='ids'>
            /// </param>
            public static object MarkMessagesAsOpened(this IRewriteMeAPI operations, IList<System.Guid?> ids = default(IList<System.Guid?>))
            {
                return operations.MarkMessagesAsOpenedAsync(ids).GetAwaiter().GetResult();
            }
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> MarkMessagesAsOpenedAsync(this IRewriteMeAPI operations, IList<System.Guid?> ids = default(IList<System.Guid?>), CancellationToken cancellationToken = default(CancellationToken))
            {
                using (var _result = await operations.MarkMessagesAsOpenedWithHttpMessagesAsync(ids, null, cancellationToken).ConfigureAwait(false))
                {
                    return _result.Body;
                }
            }
